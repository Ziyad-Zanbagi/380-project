...
public class project380 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        picture_diagonalReflectionD1 = new java.awt.Button();
        picture_diagonalReflectionD1_2 = new java.awt.Button();
        picture_diagonalReflectionD2 = new java.awt.Button();
        picture_diagonalReflectionD2_2 = new java.awt.Button();
        ...
        grayscaleToBinary = new java.awt.Button();
        ...
        resultImageLabel.setText("                                                 Image unavailable");
        ...
        picture_diagonalReflectionD1.setLabel("Diagonal Reflection D1 (top to bottom)");
        picture_diagonalReflectionD1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                picture_diagonalReflectionD1ActionPerformed(evt);
            }
        });

        picture_diagonalReflectionD1_2.setLabel("Diagonal Reflection D1 (bottom to top)");
        picture_diagonalReflectionD1_2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                picture_diagonalReflectionD1_2ActionPerformed(evt);
            }
        });

        picture_diagonalReflectionD2.setLabel("Diagonal Reflection D2 (top to bottom)");
        picture_diagonalReflectionD2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                picture_diagonalReflectionD2ActionPerformed(evt);
            }
        });

        picture_diagonalReflectionD2_2.setLabel("Diagonal Reflection D2 (bottom to top)");
        picture_diagonalReflectionD2_2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                picture_diagonalReflectionD2_2ActionPerformed(evt);
            }
        });
        ...
        panel_reflectionLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panel_reflectionLayout.createSequentialGroup()
                ...
                .addGroup(panel_reflectionLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(picture_diagonalReflectionD2_2, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(picture_diagonalReflectionD1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(picture_diagonalReflectionD1_2, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(picture_diagonalReflectionD2, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(46, 46, 46))
        );
        ...
        grayscaleToBinary.setLabel("Grayscale to Binary");
        ...
        panel_conversionsLayout.setHorizontalGroup(
            ...
            .addGroup(panel_conversionsLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(grayscaleToBinary, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addGroup(panel_pictureLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(panel_pictureLayout.createSequentialGroup()
                        .addGroup(panel_pictureLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(panelColors, javax.swing.GroupLayout.PREFERRED_SIZE, 400, Short.MAX_VALUE))
                        .addGap(18, 18, 18)
                        .addGroup(panel_pictureLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
    ...
    private void picture_browseActionPerformed(java.awt.event.ActionEvent evt) {                                               
        try {
            fileName = cpit380practice.FileChooser.pickAFile();
            inputImage = new Picture(fileName);
            resultImage = new Picture(fileName);
    ...
    private void applyColorsActionPerformed(java.awt.event.ActionEvent evt) {                                            
        try {
            Pixel[] pixelArray = resultImage.getPixels();
...
//                }
            ...
            icon = new ImageIcon(resultImage.getImage());
            resultImageLabel.setIcon(icon);
        } catch (Exception e) {
    ...
    private void picture_histogramActionPerformed(java.awt.event.ActionEvent evt) {                                                  
        // TODO add your handling code here:
    }                                                 

    private void picture_diagonalReflectionD1_2ActionPerformed(java.awt.event.ActionEvent evt) {                                                               
        Pixel leftPixel;
        Pixel rightPixel;
        try {
            for (int y = 1; y < resultImage.getHeight(); y++) {
                for (int x = 0; x < y; x++) {
                    leftPixel = resultImage.getPixel(x, y);
                    rightPixel = resultImage.getPixel(y, x);
    ...
    private void picture_horizontalReflectionActionPerformed(java.awt.event.ActionEvent evt) {                                                             
        // TODO add your handling code here:
        try {
    ...
    private void picture_verticalReflectionActionPerformed(java.awt.event.ActionEvent evt) {                                                           
        // TODO add your handling code here:
        try {
    ...
    private void picture_diagonalReflectionD1ActionPerformed(java.awt.event.ActionEvent evt) {                                                             
        Pixel leftPixel;
        Pixel rightPixel;
        try {
            for (int y = 1; y < resultImage.getHeight(); y++) {
                for (int x = 0; x < y; x++) {
                    rightPixel = resultImage.getPixel(x, y);
                    leftPixel = resultImage.getPixel(y, x);
                    rightPixel.setColor(leftPixel.getColor());
                }
            }
            icon = new ImageIcon(resultImage.getImage());
    ...
    private void picture_rotateLeftActionPerformed(java.awt.event.ActionEvent evt) {                                                   
        try {
            resultImage = resultImage.rotateLeft();
            icon = new ImageIcon(resultImage.getImage());
            resultImageLabel.setIcon(icon);
        } catch (Exception e) {
            JOptionPane.showMessageDialog(this, "Please select an image", "Picture Error", JOptionPane.ERROR_MESSAGE);
    ...
    private void picture_rotateRightActionPerformed(java.awt.event.ActionEvent evt) {                                                    
        try {
            resultImage = resultImage.rotateRight();
            icon = new ImageIcon(resultImage.getImage());
            resultImageLabel.setIcon(icon);
        } catch (Exception e) {
            JOptionPane.showMessageDialog(this, "Please select an image", "Picture Error", JOptionPane.ERROR_MESSAGE);
    ...
    private void picture_grayscaleActionPerformed(java.awt.event.ActionEvent evt) {                                                  
        try {
            Picture grayscaleImage = new Picture(resultImage);
    ...
    private void grayscaleToBinaryActionPerformed(java.awt.event.ActionEvent evt) {                                                  
        ...
        try {
            ...
            grayscaleImage.convert2Binary(threshold);
            icon = new ImageIcon(grayscaleImage.getImage());
            resultImageLabel.setIcon(icon);
        } catch (Exception e) {
    ...
    private void picture_diagonalReflectionD2ActionPerformed(java.awt.event.ActionEvent evt) {                                                             
        Pixel leftPixel;
        Pixel rightPixel;
        try {
            for (int y = resultImage.getHeight() - 2; y >= 0; y--) {
                for (int x = 0; x < resultImage.getHeight() - 1 - y; x++) {
                    leftPixel = resultImage.getPixel(x, y);
                    rightPixel = resultImage.getPixel(resultImage.getHeight() - 1
                            - y, resultImage.getHeight() - 1 - x);
                    rightPixel.setColor(leftPixel.getColor());
                }
            }
            icon = new ImageIcon(resultImage.getImage());
    ...
    private void picture_diagonalReflectionD2_2ActionPerformed(java.awt.event.ActionEvent evt) {                                                               
        Pixel leftPixel;
        Pixel rightPixel;
        try {
            for (int y = 1; y < resultImage.getHeight(); y++) {
                for (int x = 0; x < y; x++) {
                    rightPixel = resultImage.getPixel(x, y);
                    leftPixel = resultImage.getPixel(resultImage.getHeight() - 1 - y, resultImage.getHeight() - 1 - x);
                    rightPixel.setColor(leftPixel.getColor());
                }
            }
            icon = new ImageIcon(resultImage.getImage());
    ...
    private java.awt.Button grayscaleToBinary;
    ...
    private java.awt.Button picture_diagonalReflectionD1;
    private java.awt.Button picture_diagonalReflectionD1_2;
    private java.awt.Button picture_diagonalReflectionD2;
    private java.awt.Button picture_diagonalReflectionD2_2;
