...
public class MovieMaker {
    ...
    public void makeRectangleMovie(String directory) {
        ...
        for (int i = 0; i < framesPerSec; i++) {
            ...
            g.fillRect(590 - (i * 14), i * 14, 75, 75);
...
//   {
    /**
     * Method to make a movie that has a rectangle moving from top right to
     * bottom left
     *
     * @param directory the directory to put the movie frames
     */
    ...
    public void makeRectMovieMoveSinCon(String directory) {
        int framesPerSec = 30;
        Picture p = null;
        Graphics g = null;
        FrameSequencer frameSequencer
...
//      g.fillRect(i * 10, i * 5, 50,50);
            g.setColor(Color.BLUE);
            g.fillRect(i * 20, (int) (i * 20 * Math.sin(i * (2 * 3.14 / 180.0))), 50, 50);
    ...
    public void makeFadeOutMovie(String directory) {
        ...
        String beachF = FileChooser.pickAFile();//moon.jpg
        ...
        // loop creating the frames
        for (int i = 0; i < framesPerSec * 6; i++) {
